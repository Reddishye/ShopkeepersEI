...
public class reloadSubCommand extends SubCommandsManager {
    ...
    public reloadSubCommand(
            ConfigContainer<Config> configContainer, BukkitAudiences bukkitAudiences) {
        super();
    ...
    @Override
    public void execute(
            @NotNull CommandSender sender, @NotNull String args, @NotNull String[] strings) {
        configContainer.reload();
        bukkitAudiences
                .sender(sender)
                .sendMessage(translate(configContainer.get().messages.pluginReloaded));
    }
}
